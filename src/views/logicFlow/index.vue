                        ...
                        <div class="dndPanel" ref="dndPanelRef">
                            ...
                            <div class="modelDiv">
                                ...
                                <div v-else class="algorithmNode x1" v-for="item in paginatedAlgorithm" :key="item.id">
                                    ...
                                    <el-tooltip
                                        v-if="state.isOverflowing"
                                        :content="item.algorithmName"
                                        placement="right"
                                        :offset="30"
                                    >
                                        <span class="text" @mouseenter="checkOverflow">{{ item.algorithmName }}</span>
                                    </el-tooltip>
                                    <span v-else class="text" @mouseenter="checkOverflow">{{
                                        item.algorithmName
                                    }}</span>
                                </div>
            ...
            >
                ...
                <el-tooltip content="显示组件" placement="right" :show-after="400" :hide-after="0">
                    <transition name="slide-fade">
                        <button
                            v-show="state.isCollapsed && state.showExpandBtn"
                            class="collapse-right-btn"
                            @click="showSide"
                        >
...
<script setup>
    ...
    onMounted(async () => {
        ...
        state.lf.on('graph:rendered', ({ graphModel }) => {
